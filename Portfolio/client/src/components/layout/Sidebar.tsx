...
const infoSections = [
    { title: 'О себе', content: 'Мое имя Владимир, мне 22 года, я начинающий разработчик с фокусом на C# и Python. Разработал ML-модуль для платформы UAMS, Разработал информационную систему на Django, Разрабатывал игры на Unity, работал с s&box, использовал Hammer editor, ' },
